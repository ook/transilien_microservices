...
describe Transilien::MicroService do
  ...
  it 'should generate correct params params for one simple filter' do
  ...
  it 'should generate correct params params for two simple filters' do
  ...
  it 'should generate correct params params for one simple filter with Array, or is the default logic operator for arrays' do
  ...
  it 'should generate correct params params for two simple filters with Array, or is the default logic operator for arrays' do
  ...
  it 'should generate correct params params for one complex filter' do
  ...
  it 'should generate correct params params for two complex filters' do
